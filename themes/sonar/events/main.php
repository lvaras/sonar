...
class events {
	...
	{ 
	    ...
	    /* OK, its safe for us to save the data now. */
  	    ...
  	    foreach ($_POST["event_meta"] as $input_name => $value) 
  	    {
  			...
  			$test .= "key: _$input_name <--> value: $sanitazed_data\n\n";
  		}
  		update_post_meta( $post_id, "test_post_arr", $test );  
	...
	public function enqueue_script_and_styles () 
	{
		...
		wp_enqueue_script('jquery-timepicker', get_template_directory_uri() . '/events/jquery.timepicker.min.js');
		wp_enqueue_script('admin_scripts', get_template_directory_uri() . '/events/admin_scripts.js' , array( "jquery_ui" , "jquery-timepicker" ) );
		wp_enqueue_style('sonar_admin_css', get_template_directory_uri() . '/events/admin_styles.css' );
