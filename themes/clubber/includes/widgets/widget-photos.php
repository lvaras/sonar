...
class Photos_Widget extends WP_Widget {
    ...
    function Photos_Widget() {
        ...
        $this->WP_Widget('photos-widget', __('CLUBBER - Photos', 'clubber'), $widget_opts);
    }
    /*--------------------------------------------------*/
    /* DISPLAY THE WIDGET
    /*--------------------------------------------------*/
...
<?php
    ...
    <div class="widgets-col-photo">
	  ...
	  <a href="' . $cover_large[0] . '" class="photo-preview" data-rel="prettyPhoto-widget[pp_gallery]">' . $cover_gallery . '</a>
